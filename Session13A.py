...
dish1 = Dish("Dal Makhani", 200, "Black Lentils Cooked Overnight", "Shudh Vaishno")
dish2 = Dish("Paneer Makhani", 300, "Makhanwala Paneer", "Shudh Vaishno")
dish3 = Dish("Burger", 100, "Tikkiwala Burger", "American")
